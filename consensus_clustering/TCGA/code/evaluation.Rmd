...
pander::pandoc.table(RS, split.table = 300, justify = "lc")
```
...
pander::pandoc.table(index.summary, split.table = 300,
                     justify = paste0("l",
...
pander::pandoc.table(ranked.indices, split.table = 300,
                     justify = paste0("l",
...
pander::pandoc.table(ranked.sums, split.table = 300,
                     justify = paste0("l",
...
```{r worms_plot}
sw <- shapes.worms()
plot(sw$data, col = c(2:3)[sw$clusters], xlab = "x", ylab = "y",
