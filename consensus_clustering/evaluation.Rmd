...
We will rank each algorithm on the indices using the minimum rank to break ties. For example, if two algorithms are tied for third, the next best algortihm is ranked fifth. This method is commonly used in sports.
