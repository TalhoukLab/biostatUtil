...
The weights below are calculated using PAC and CHI. Finally, the confusion matrix with the weighted meta-consensus clusters and UCI reference clusters is shown:
...
The weighted meta-consensus clusters gave the highest accuracy, providing further evidence that the aggregation over algorithms is a feasible notion.
