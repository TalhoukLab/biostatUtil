...
par(mfrow=c(1,3))
hist(boot.hrs.os, main="Overall survival", xlab="log hazard ratio on bootstrap samples")
hist(boot.hrs.dss,main="Disease specific survival", xlab="log hazard ratio on bootstrap samples")
hist(boot.hrs.rfs,main="Progression free survival", xlab="log hazard ratio on bootstrap samples")
```