...
# width/height = 13/5
#par(mfrow=c(1,2))
doKMPlotsPOLE(emdb, "os", use.aline.plot = USE.ALINE.KM.PLOT)
```
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb, "os", use.aline.plot = USE.ALINE.KM.PLOT)
```

**KM plots - disease specific survival**
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
#par(mfrow=c(1,2))
doKMPlotsPOLE(emdb, "dss", use.aline.plot = USE.ALINE.KM.PLOT)
```
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb, "dss", use.aline.plot = USE.ALINE.KM.PLOT)
```

**KM plots - relapse free survival**
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
#par(mfrow=c(1,2))
doKMPlotsPOLE(emdb, "rfs", use.aline.plot = USE.ALINE.KM.PLOT)
```
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb, "rfs", use.aline.plot = USE.ALINE.KM.PLOT)
```
