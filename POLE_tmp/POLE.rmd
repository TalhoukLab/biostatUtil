...
taos=biostatUtil::testInter(dat1,event="OS",use.firth=TRUE)
biostatUtil::printInterModels(taos[[1]],taos[[2]],taos[[3]],"Overall Survival. ")
...
tao=biostatUtil::testInter(dat1,event="DSS",use.firth=TRUE)
biostatUtil::printInterModels(tao[[1]],tao[[2]],tao[[3]],"Disease Specific Survival. ")
...
tao=biostatUtil::testInter(dat1,event="RFS",use.firth=TRUE)
biostatUtil::printInterModels(tao[[1]],tao[[2]],tao[[3]],"Relapse Free Survival. ")
...
dat1=dat0[complete.cases(dat0),]
mod=biostatUtil::coxphOut(coxph(Surv(OS.yrs,OS.sts=="os.event")~POLE+Age+grade+Histology+Rx,data=dat1),c("POLE wt","Age","Grade","Histology","Any Rx"))
biostatUtil::printCoxMod(mod,"Multivariable Model excluding Stage and BMI")
```
...
dat1=dat0[complete.cases(dat0),]
mod=biostatUtil::coxphOut(coxph(Surv(OS.yrs,OS.sts=="os.event")~POLE+Age+grade+Histology+Rx+bmi+nodes,data=dat1),c("POLE wt","Age","High Grade","Histology Endo","Any Rx","BMI","Any Nodes"))
biostatUtil::printCoxMod(mod,"Multivariable Model excluding Stage")
```
-->
