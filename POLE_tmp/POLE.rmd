...
doKMPlotsPOLE(emdb, time = "os.yrs", status = "os.sts == 'os.event'",
              surv.type = "os", xlabs = "Total follow-up (years)",
              ylabs = "Overall survival", use.aline.plot = USE.ALINE.KM.PLOT)
```

```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb, time = "os.yrs", status = "os.sts == 'os.event'",
                     surv.type = "os", xlabs = "Total follow-up (years)",
                     ylabs = "Overall survival", use.aline.plot = USE.ALINE.KM.PLOT)
```
...
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLE(emdb[!is.na(emdb$dss.sts), ],
              time = "dss.yrs", status = "dss.sts == 'dss.event'",
              surv.type = "dss", xlabs = "Total follow-up (years)",
              ylabs = "Disease specific survival (DSS)", use.aline.plot = USE.ALINE.KM.PLOT)
```

```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb[!is.na(emdb$dss.sts), ],
              time = "dss.yrs", status = "dss.sts == 'dss.event'",
              surv.type = "dss", xlabs = "Total follow-up (years)",
              ylabs = "Disease specific survival (DSS)", use.aline.plot = USE.ALINE.KM.PLOT)
```
...
```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLE(emdb[!is.na(emdb$rfs.sts) & !is.na(emdb$rfs.yrs), ],
              time = "rfs.yrs", status = "rfs.sts == 'rfs.event'",
              surv.type = "pfs", xlabs = "Any relapse-free survival time",
              ylabs = "Any relapse-free survival",  use.aline.plot = USE.ALINE.KM.PLOT)
```

```{r message=FALSE,echo=FALSE,results='hide',fig.keep='all', fig.width=8, fig.height=6}
doKMPlotsPOLEInitTrt(emdb[!is.na(emdb$rfs.sts) & !is.na(emdb$rfs.yrs), ],
              time = "rfs.yrs", status = "rfs.sts == 'rfs.event'",
              surv.type = "pfs", xlabs = "Any relapse-free survival time",
              ylabs = "Any relapse-free survival",  use.aline.plot = USE.ALINE.KM.PLOT)
```
...
pander::pander(ftable(xtabs(~POLE+Rx+OS.sts,data=dat1)),style='rmarkdown')
```
...
pander::pander(ftable(xtabs(~POLE+Rx+DSS.sts,data=dat1)),style='rmarkdown')
```
...
pander::pander(ftable(xtabs(~POLE+Rx+RFS.sts,data=dat1)),style='rmarkdown')
...
par(mfrow = c(1, 3))
doCheckPH(emdb, "POLE.mut.germline.as.missing", "POLE mutation")
```
