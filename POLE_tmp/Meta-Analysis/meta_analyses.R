...
studlab <- c("PORTEC", "Leuven", "TCGA", "Meng","VGH")
effects <- log(c(0.43, 0.18, 0.12, 0.7558702,0.23))
...
studlab <- c("PORTEC", "Billingsley", "Meng","VGH")
effects <- log(c(1.06, 0.37, 0.6796932,0.8))
