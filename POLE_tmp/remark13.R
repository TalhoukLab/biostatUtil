...
factor.levels <- c(factor.levels[factor.levels!=MISSING.EXPLICIT],MISSING.EXPLICIT)
emdb.for.cohort.char$stage <- factor(emdb.for.cohort.char$stage,levels=factor.levels)
...
factor.levels <- c(factor.levels[factor.levels!=MISSING.EXPLICIT],MISSING.EXPLICIT)
emdb.for.cohort.char$LVSI <- factor(emdb.for.cohort.char$LVSI,levels=factor.levels)

emdb.for.cohort.char$any.positive.nodes.for.cohort.char <- sapply(emdb.for.cohort.char$any.positive.nodes.for.cohort.char,as.character)
factor.levels <- c(names(table(emdb.for.cohort.char$any.positive.nodes.for.cohort.char)),MISSING.EXPLICIT)
emdb.for.cohort.char$any.positive.nodes.for.cohort.char[is.na(emdb.for.cohort.char$any.positive.nodes.for.cohort.char)] <- MISSING.EXPLICIT
emdb.for.cohort.char$any.positive.nodes.for.cohort.char <- factor(emdb.for.cohort.char$any.positive.nodes.for.cohort.char,levels=factor.levels)

emdb.for.cohort.char$init.treatment <- sapply(emdb.for.cohort.char$init.treatment,as.character)
factor.levels <- c(names(table(emdb.for.cohort.char$init.treatment)),MISSING.EXPLICIT)
...
item13.cohort.missing <- doCohortCharacteristics(emdb,"POLE.mut.germline.as.missing","POLE",
	...
	stat.tests=c("fisher","fisher","fisher","fisher","fisher","fisher","fisher","fisher"),
