...
test_that("No output if requested statistic not found", {
  ...
  ssb1 <- SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = "mpg", stats = stats.in1)
  ssb2 <- SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = "mpg", stats = stats.in2)
  expect_identical(ssb1, ssb2)
})

test_that("Order of input/output statistics match", {
  stats.in <- c("median", "range", "mean", "missing", "IQR")
  ssb <- SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = "mpg", stats = stats.in)
...
test_that("Error thrown if argument names misspelled", {
  expect_error(SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = c("mpgg")))
  expect_error(SummaryStatsBy(mtcars, by1 = "cl", by2 = "ger", var.names = c("mpg")))
})

test_that("Error if trying to split by one level factor", {
  expect_error(SummaryStatsBy(mtcars, by1 = "onelev", by2 = "gear", var.names = "mpg"))
  expect_error(SummaryStatsBy(mtcars, by1 = "gear", by2 = "onelev", var.names = "mpg"))
})

test_that("No error if factor has only one level", {
  expect_error(SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = "onelev"), NA)
})

test_that("No errors for single continuous/categorical variable", {
  expect_error(SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = c("mpg")), NA)
  expect_error(SummaryStatsBy(mtcars, by1 = "cyl", by2 = "gear", var.names = c("vs")), NA)
})